...
namespace webApi1.Controllers
{
    ...
    public class PersonPropertyController : ControllerBase
    {
        IPersonBL _personBL;
        ILogger<PersonPropertyController> _ilogger;
        IMapper _mapper;

        public PersonPropertyController(IPersonBL personBL, ILogger<PersonPropertyController> logger, IMapper mapper )
        {
            _personBL = personBL;
            _ilogger = logger;
            _mapper = mapper;
